...
jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()().ready(function () {
  ...
  if (!jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()("#form").hasClass("has-thumbnail")) {
    ruleThumbnail = {
      required: true
    };
  }
